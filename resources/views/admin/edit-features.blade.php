...
<div class="col-sm-10">
<input type="text" name="fa_icon" value="{{$feature->fa_icon}}" class="form-control" id="input-text" placeholder="FA Icon">
...
<div class="col-sm-10">
<input type="text" name="highlight_text" class="form-control" value="{{$feature->highlight_text}}" id="input-text" placeholder="Highlight Text">
</div>
</div>
</br>
</br>
...
<div class="col-sm-10">
<input type="text" name="small_description" class="form-control" value="{{$feature->small_description}}" id="input-text" placeholder="Small Description">
</div>
</div>
</br>
</br>
...
<div class="col-sm-10">
<textarea type="text" name="full_description"  value="" class="form-control" id="myeditor" placeholder="Full Description">{{$feature->full_description}}</textarea>
</div>
</div>
</br>
</br>
