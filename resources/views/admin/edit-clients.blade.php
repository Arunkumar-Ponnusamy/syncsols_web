...
<div class="widget">
<div class="widget-header transparent">
<h2><strong>Our</strong> Clients/Partners</h2>
<div class="additional-btn">
<a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
<!-- 							<a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
<a href="#" class="widget-close"><i class="icon-cancel-3"></i></a> -->
...
<div class="col-sm-10">
    ...
    <img style="height: 90px; margin-bottom: 15px; border-radius:1em;" src="{{img($client->picture)}}">
    @endif
    <input type="file" name="picture" id="input-file-max-fs" class="dropify" data-max-file-size="10M" />
</div>
</div>
</br>
</br>
...
<div class="col-sm-10">
<input type="text" name="name" value="{{$client->name}}" class="form-control" id="input-text" placeholder="Name">
</div>
</div>
</br>
</br>
...
<div class="form-group">
<label for="input-text" class="col-sm-2 control-label">Refer Link</label>
<div class="col-sm-10">
<input type="text" name="refer_link" value="{{$client->refer_link}}" class="form-control" id="input-text" placeholder="Refer Link">
</div>
</div>
</br>
</br>
...
<div class="col-sm-10">
<textarea type="text" name="description"  value="{{$client->description}}" class="form-control" placeholder="Description">{{$client->description}}</textarea>
</div>
</div>
</br>
</br>
