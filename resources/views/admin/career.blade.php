...
<div class="widget">
<div class="widget-header transparent">
<h2><strong>Career</strong> Update</h2>
<div class="additional-btn">
<a href="#" class="hidden reload"><i class="icon-ccw-1"></i></a>
<!-- 							<a href="#" class="widget-toggle"><i class="icon-down-open-2"></i></a>
<a href="#" class="widget-close"><i class="icon-cancel-3"></i></a> -->
...
<div class="widget-content padding">
<form action="{{url('admin/careers')}}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}                      
        ...
        <tbody>
          @foreach($careers as $index=>$career)
            <tr>
                <td>{{$index+1}}</td>
                <td>
                                    <a href="{{url('admin/careers/'.$career->id)}}" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</a>
                                    <a href="{{url('admin/careers/delete/'.$career->id)}}"><button class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i> Delete</button></a>
                </td>
            </tr>
          @endforeach
        </tbody>
