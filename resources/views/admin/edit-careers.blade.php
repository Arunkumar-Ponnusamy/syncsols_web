...
<div class="widget-content padding">
<form action="{{url('admin/careers/'.$career->id)}}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}                      

<div class="form-group">
<label for="input-text" class="col-sm-2 control-label">Content</label>
<div class="col-sm-10">
<textarea type="text" id="myeditor" name="content"  value="" class="form-control" placeholder="Content">{{$career->content}}</textarea>
</div>
</div>
</br>
</br>
