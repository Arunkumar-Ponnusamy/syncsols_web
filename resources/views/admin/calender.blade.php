...
<div class="topbar">
    ...
    <div class="navbar" role="navigation">
        ...
        </button> <h1 class="title">Calendar</h1>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="footer">
                    ...
                    <li class="dropdown topbar-profile">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="rounded-image topbar-profile-image"><img src="{{BASE_URL}}public/images/users/user-40.jpg"></span> Stephen Smith </a>
                        <ul class="dropdown-menu">
        ...
        <div class="left side-menu">
            <div class="sidebar-inner slimscrollleft">
                ...
                <div class="profile-info">
                    <div>
                      <a href="profile.html" class="rounded-image profile-image"><img src="{{BASE_URL}}public/images/users/user-100.jpg"></a>
                    </div>
                    <div>
                        <div class="profile-text">Stephen Smith</div>
...
<div class="box box-widget widget-user">
	...
	<script src="{{BASE_URL}}public/assets/libs/jquery/jquery-1.11.1.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap/js/bootstrap.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jqueryui/jquery-ui-1.10.4.custom.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jquery-ui-touch/jquery.ui.touch-punch.min.js"></script>
	
	<script src="{{BASE_URL}}public/assets/libs/jquery-animate-numbers/jquery.animateNumbers.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/ios7-switch/ios7.switch.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/fastclick/js/fastclick.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jquery-blockui/jquery.blockUI.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap-bootbox/bootbox.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jquery-slimscroll/jquery.slimscroll.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jquery-sparkline/jquery-sparkline.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/nifty-modal/js/classie.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/nifty-modal/js/modalEffects.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/sortable/sortable.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap-fileinput/bootstrap.file-input.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap-select/bootstrap-select.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap-select2/select2.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/magnific-popup/jquery.magnific-popup.min.js"></script> 
	<script src="{{BASE_URL}}public/assets/libs/pace/pace.min.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
	<script src="{{BASE_URL}}public/assets/libs/jquery-icheck/icheck.min.js"></script>

	<!-- Demo Specific JS Libraries -->
	<script src="{{BASE_URL}}public/assets/libs/prettify/prettify.js"></script>

	<script src="{{BASE_URL}}public/assets/js/init.js"></script>
    <!-- Page Specific JS Libraries -->
	<script src="{{BASE_URL}}public/assets/libs/fullcalendar/fullcalendar.min.js"></script>
	<script src="{{BASE_URL}}public/assets/js/pages/calendar.js"></script>
	</body>
