		...
		<div class="container marketing">
			...
			<div class="row inner-sec-w3layouts-agileinfo">
				...
				<div class="col-lg-7 bt-bottom-info ab">
					<img src="{{asset('public/assets/new/images/ab.png')}}" class="img-responsive" alt=" ">
...
<!-- 	<section class="services">
		<div class="container">
			...
			<div class="row inner-sec-w3layouts-agileinfo">
				<div class="col-md-3 col-sm-6 team-grids" data-aos="flip-left">
					<img src="{{asset('public/assets/new/images/p1.jpg')}}" class="img-responsive" alt="">
					<div class="team-info">
						<div class="caption">
							<h4>John Doe</h4>
							<h6>Founder
	...
	<!--//services-->
	<!---->
	<section class="grids_sec_2 career">
		@if(isset($career->content))
		{!! $career->content !!}
		@endif
	</section>
	<!---->
